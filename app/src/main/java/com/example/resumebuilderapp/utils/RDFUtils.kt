...
fun generateResumePDFToURI(
    ...
    val titlePaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        textSize = 20f; typeface = android.graphics.Typeface.create(
        android.graphics.Typeface.DEFAULT,
        android.graphics.Typeface.BOLD
    )
    }
    val headerPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        textSize = 12f; typeface = android.graphics.Typeface.create(
        android.graphics.Typeface.DEFAULT,
        android.graphics.Typeface.BOLD
    )
    }
    val divider = Paint().apply {
        color = android.graphics.Color.BLACK; strokeWidth = 1f
    }
    var y = 40f
    photo?.let {
        val safeBitmap = it.toSoftwareBitmap()
